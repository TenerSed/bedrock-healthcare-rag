"""
Healthcare Assistant Core Module
Patient-specific RAG system using MIMIC-IV + AWS Bedrock
Designed for both CLI and Lambda deployment
"""
...
class Config:
    """Configuration from environment variables (Lambda-compatible)"""
    AWS_REGION = os.getenv('AWS_REGION', 'us-east-1')
    KNOWLEDGE_BASE_ID = os.getenv('KNOWLEDGE_BASE_ID', '0U6HHF7FWC')
...
class HealthcareAssistant:
    ...
    def __init__(self, subject_id: int, session_id: Optional[str] = None):
        ...
        self.session_id = session_id  # Accept existing session_id
